...
$(document).ready(function() {
    ...
    if ($(".usertable").length > 0) {
        var opt = {
            ...
            "oLanguage": {
                ...
                "sInfo": "Hiển thị <span>_START_</span> tới <span>_END_</span> của <span>_TOTAL_</span> danh sách",
                "sLengthMenu": "_MENU_ <span>Số dòng hiển thị</span>"
            },
            'sDom': "lfrtip",
            'aoColumnDefs': [{
                'bSortable': false,
	...
	if ($(".usertable2").length > 0) {
        ...
        var oTable = $('.usertable2').dataTable(opt);
	...
	if ($(".usertable4").length > 0) {
        ...
        $(".usertable4").css("width", '100%');
    }
	
	if ($(".usertable6").length > 0) {
        var opt = {
            "sPaginationType": "full_numbers",
            "oLanguage": {
                "sSearch": "<span>Tìm kiếm:</span> ",
        ...
        var oTable = $('.usertable6').dataTable(opt);
